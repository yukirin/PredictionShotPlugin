...
### `Functions`
 ...
 |--:|---|---|
 |FRotator|Prediction(<br>const float BulletSpeed,<br>const float BulletGravityScale,<br>const float TargetGravityScale,<br>const FVector& From,<br>const FVector& To<br>)|Calculate predicted shooting direction<br><br>BulletGravityScale - Set the value of GravityScale set for the bullet to be shot|
